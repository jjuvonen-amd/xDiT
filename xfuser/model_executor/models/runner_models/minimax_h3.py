...
class xFuserFastH3Model(xFuserMiniMaxH3Model):
    ...
    ``AITER_BF16_VSA_H3`` and ``AITER_FP8_VSA_H3`` run it through AITER's
    64x64 sorted-sparse MHA v4 rows on gfx950; other MiniMax-H3 backends
    stay dense when selected explicitly.
    """
